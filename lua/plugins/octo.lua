return {
  ...
  config = function()
    require "octo".setup({
      ...
      snippet_context_lines = 10, -- number or lines around commented lines
      ...
      issues = {
        order_by = {            -- criteria to sort results of `Octo issue list`
          field = "CREATED_AT", -- either COMMENTS, CREATED_AT or UPDATED_AT (https://docs.github.com/en/graphql/reference/enums#FFC0CB)
          direction =
          "DESC"                -- either DESC or ASC (https://docs.github.com/en/graphql/reference/enums#FFC0CB)
        }
      },
      pull_requests = {
